...
namespace AbsoluteCinema.Infrastructure.Migrations
{
    ...
    [Migration("20250204141737_DeleteUslessRequiredsInHall")]
    partial class DeleteUslessRequiredsInHall
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AbsoluteCinema.Infrastructure.Identity.Data.ApplicationRole", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AbsoluteCinema.Infrastructure.Identity.Data.ApplicationUser", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("AbsoluteCinema.Domain.Entities.Ticket", b =>
                {
                    ...
                    b.HasOne("AbsoluteCinema.Infrastructure.Identity.Data.ApplicationUser", "ApplicationUser")
                        .WithMany("Tickets")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityRoleClaim<int>", b =>
                {
                    b.HasOne("AbsoluteCinema.Infrastructure.Identity.Data.ApplicationRole", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<int>", b =>
                {
                    b.HasOne("AbsoluteCinema.Infrastructure.Identity.Data.ApplicationUser", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
